...
class Validoc_Psshop_Model_Resource_Setup extends Mage_Eav_Model_Entity_Setup {
...
//        $entityTypeId = $this->getEntityType(Southernmonkeys_Cruiseline_Model_Ship::ENTITY_TYPE, 'entity_type_id');
//        $attributeSetId = $this->getAttributeSet($entityTypeId, Southernmonkeys_Cruiseline_Model_Ship::EAV_ATTRIBUTE_SET, 'attribute_set_id');
