...
class Validoc_Psshop_Adminhtml_Synchronization_ProfileController extends Mage_Adminhtml_System_Convert_ProfileController
{
    ...
    public function indexAction()
    {
         ...
         */
        $this->_setActiveMenu('psshop/synchronization');

        /**
         * Append profiles block to content
         */
        $this->_addContent(
            $this->getLayout()->createBlock('psshop/adminhtml_synchronization', 'convert_profile')
        );
    ...
    public function gridAction()
    {
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('psshop/adminhtml_synchronization_grid')->toHtml()
        );
    }
    ...
    public function editAction()
    {
        ...
        $this->_addContent(
            $this->getLayout()->createBlock('psshop/adminhtml_synchronization_edit')
        );

        /**
         * Append edit tabs to left block
         */
        $this->_addLeft($this->getLayout()->createBlock('psshop/adminhtml_synchronization_edit_tabs'));
    ...
    public function saveAction()
    {
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                $profile->setEntityType('synchronization');
                $profile->save();
    ...
    public function historyAction() {
        $this->_initProfile();
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('psshop/adminhtml_synchronization_edit_tab_history')->toHtml()
        );
    }

    protected function _isAllowed()
    {
        // TODO-jconde: actualizar este codigo
